...
void MX_DAC_Init(void)
{
  ...
  */
  ...
  sConfig.DAC_OutputBuffer = DAC_OUTPUTBUFFER_ENABLE;//DAC_OUTPUTBUFFER_ENABLE
...
void HAL_DAC_MspInit(DAC_HandleTypeDef* dacHandle)
{
  ...
  /* USER CODE END DAC_MspInit 0 */
    ...
    PA5     ------> DAC_OUT2 
    */
    GPIO_InitStruct.Pin = AO0_CN11_32_Pin|AO1_CN12_11_Pin;
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* dacHandle)
{
  ...
  /* USER CODE END DAC_MspDeInit 0 */
    ...
    PA5     ------> DAC_OUT2 
    */
    HAL_GPIO_DeInit(GPIOA, AO0_CN11_32_Pin|AO1_CN12_11_Pin);
