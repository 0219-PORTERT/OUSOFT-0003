...
uint16_t Simtemp1(void){
	/*TM_I2C_Write(I2C4, POT1KA_I2CADD, 0x00, 0x00);
	HAL_Delay(10);
	TM_I2C_Write(I2C4, POT100KA_I2CADD, 0x00, 0x00);
	...
	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x38, &val);
	tolRabTab[0][0] = val;
	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x39, &val);
	tolRabTab[1][0] = val;


	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3A, &val);
	tolRabTab[0][1] = val;
	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3B, &val);
	tolRabTab[1][1]  = val;


	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3C, &val);
	tolRabTab[0][2] = val;
	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3D, &val);
	tolRabTab[1][2 ]= val;


	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3E, &val);
	tolRabTab[0][3] = val;
	TM_I2C_Read(I2C4, (POT100KA_I2CADD | (1u << 0)), 0x3F, &val);
	tolRabTab[1][3] = val;
*/
